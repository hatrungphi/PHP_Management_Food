                    ...
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form id="contact" action="../controller/UserController.php" method="post">
                            <div class="form-floating mb-3">
                                <input name="txt_username" type="text" class="form-control" id="floatingText" placeholder="jhondoe">
                            ...
                            <button name="dangky" type="submit" class="btn btn-primary py-3 w-100 mb-4">Sign Up</button>
